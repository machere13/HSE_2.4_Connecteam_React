...
import styles from './M_InteractivesGeneratorDirectionPlate.module.css'

import type gsap from 'gsap'

export default function M_InteractivesGeneratorDirectionPlate() {
  ...
  return (
    <div className={styles.wrapper}>
      <div className={styles.content}>
        ...
        <p>Придумали за&nbsp;вас классные идеи тимбилдингов для вашего командного коннекта</p>
